    ...
    >
        @if(session('success'))
            <div
                ...
                style="background-color: #1a3a27; color: #d1fae5; font-family: var(--font-body); font-size: 0.875rem; font-weight: 500;"
            >
        ...
        @if(session('error'))
            <div
                class="flex items-start gap-3 px-4 py-3"
                style="background-color: #450a0a; color: #fecaca; font-family: var(--font-body); font-size: 0.875rem; font-weight: 500;"
            >
        ...
        @if(session('info'))
            <div
                class="flex items-start gap-3 px-4 py-3"
                style="background-color: #1e3a5f; color: #bfdbfe; font-family: var(--font-body); font-size: 0.875rem; font-weight: 500;"
            >
        ...
        @if(session('warning'))
            <div
                class="flex items-start gap-3 px-4 py-3"
                style="background-color: #451a03; color: #fde68a; font-family: var(--font-body); font-size: 0.875rem; font-weight: 500;"
            >
