            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem;">
                        <li><a href="{{ route('shop') }}?category=jewelry" style="font-size: 0.8125rem; color: rgba(244, 241, 234, 0.75); transition: color 0.15s;" onmouseover="this.style.color='#F4F1EA'" onmouseout="this.style.color='rgba(244,241,234,0.75)'">Jewelry</a></li>
                        <li><a href="{{ route('shop') }}?category=boxes" style="font-size: 0.8125rem; color: rgba(244, 241, 234, 0.75); transition: color 0.15s;" onmouseover="this.style.color='#F4F1EA'" onmouseout="this.style.color='rgba(244,241,234,0.75)'">Boxes</a></li>
                        <li><a href="{{ route('shop') }}?category=tumblers" style="font-size: 0.8125rem; color: rgba(244, 241, 234, 0.75); transition: color 0.15s;" onmouseover="this.style.color='#F4F1EA'" onmouseout="this.style.color='rgba(244,241,234,0.75)'">Tumblers</a></li>
                        <li><a href="{{ url('/shop') }}" style="font-size: 0.8125rem; color: rgba(244, 241, 234, 0.75); transition: color 0.15s;" onmouseover="this.style.color='#F4F1EA'" onmouseout="this.style.color='rgba(244,241,234,0.75)'">All Products</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem;">
                        <li><a href="{{ url('/about-us') }}" style="font-size: 0.8125rem; color: rgba(244, 241, 234, 0.75); transition: color 0.15s;" onmouseover="this.style.color='#F4F1EA'" onmouseout="this.style.color='rgba(244,241,234,0.75)'">About</a></li>
                        <li><a href="{{ url('/journal') }}" style="font-size: 0.8125rem; color: rgba(244, 241, 234, 0.75); transition: color 0.15s;" onmouseover="this.style.color='#F4F1EA'" onmouseout="this.style.color='rgba(244,241,234,0.75)'">Journal</a></li>
                        <li><a href="{{ url('/contact') }}" style="font-size: 0.8125rem; color: rgba(244, 241, 234, 0.75); transition: color 0.15s;" onmouseover="this.style.color='#F4F1EA'" onmouseout="this.style.color='rgba(244,241,234,0.75)'">Contact</a></li>
                        <li><a href="{{ url('/faq') }}" style="font-size: 0.8125rem; color: rgba(244, 241, 234, 0.75); transition: color 0.15s;" onmouseover="this.style.color='#F4F1EA'" onmouseout="this.style.color='rgba(244,241,234,0.75)'">FAQ</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div>
                ...
                <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem;">
                    <a
                        ...
                        style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; border: 1px solid rgba(244,241,234,0.25); color: rgba(244,241,234,0.75); transition: color 0.15s, border-color 0.15s;"
                        onmouseover="this.style.color='#F4F1EA'; this.style.borderColor='rgba(244,241,234,0.6)'"
                        onmouseout="this.style.color='rgba(244,241,234,0.75)'; this.style.borderColor='rgba(244,241,234,0.25)'"
                    >
                    ...
                    <a
                        href="{{ config('social.pinterest', 'https://pinterest.com') }}"
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                <form action="{{ url('/newsletter') }}" method="POST" class="flex gap-0">
                    @csrf
                    <input
                        type="email"
                        name="email"
