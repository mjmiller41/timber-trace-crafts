...
<div style="max-width: 720px;">
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <span class="admin-card-title">Edit: {{ $coupon->code }}</span>
            <span style="font-size: 0.8125rem; color: #6b7280;">Used {{ $coupon->used_count }} {{ Str::plural('time', $coupon->used_count) }}</span>
        </div>
