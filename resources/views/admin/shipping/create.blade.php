...
@section('page-title', 'New Shipping Method')
...
<div style="max-width: 600px;">
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <span class="admin-card-title">New Shipping Method</span>
        </div>
        ...
        <form method="POST" action="{{ route('admin.shipping.store') }}">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1rem;">
                ...
                <div>
                    ...
                    <input type="text" id="service_code" name="service_code" class="admin-input"
                        value="{{ old('service_code') }}" placeholder="e.g. usps_ground" required>
                </div>
            </div>
            ...
            <div style="margin-bottom: 1rem;">
                ...
                <input type="text" id="description" name="description" class="admin-input"
                    value="{{ old('description') }}" placeholder="e.g. Arrives in 5–7 business days">
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1rem;">
                <div>
                    ...
                    <input type="number" id="price_override" name="price_override" class="admin-input"
                        value="{{ old('price_override') }}" step="0.01" min="0" placeholder="Leave blank to calculate">
            ...
            <div style="display: flex; gap: 0.75rem; padding-top: 0.5rem; border-top: 1px solid #f3f4f6;">
                <button type="submit" class="admin-btn admin-btn-primary">Create Method</button>
